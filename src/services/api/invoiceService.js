  ...
  try {
    ...
    const params = {
      records: [{
        ...
        clientId: invoiceData.clientId ? parseInt(invoiceData.clientId) : null,
  ...
  try {
    ...
    const params = {
      records: [{
        ...
        clientId: invoiceData.clientId ? parseInt(invoiceData.clientId) : null,
        projectId: invoiceData.projectId ? parseInt(invoiceData.projectId) : null,
...
export const markInvoiceAsSent = async (id) => {
  try {
    ...
    // First get the current invoice to check status
